...
import { MyContext } from "../Appp/context";
...
export default function Home(){
        ...
        const fetchUserProfile = async () => {
            ...
            try{
                const res = await axios.get(
                    "https://ryrv32-8081.csb.app/api/admin/profile",
                    {headers: headers}
                    )
    ...
    return(
        ...
        >
            ...
            {/* <span style = {{ visibility: "hidden",  display: "inline-block", animation-name:"fade-in",animation-duration:"1s",animation-timing-function: "linear",animation-fill-mode: "forwards",opacity: "0"}}></span> */}
